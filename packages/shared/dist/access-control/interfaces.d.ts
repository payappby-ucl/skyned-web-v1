...
export interface IAccessControl {
    ...
    attribute<Res extends ResourceType, Act extends PermissionType[Res]["action"]>(auth: AuthClaim, resourceName: Res, action: Act, ...args: Act extends "list" ? [] : Act extends "update" ? [
