...
exports.EnglishProficiency = void 0;
const scores = [
    {
        name: "A1",
...
class EnglishProficiency {
    ...
    static computeExaminationScore(input) {
        switch (input.test) {
            case "ielts": {
                const average = (input.listening + input.reading + input.speaking + input.writing) /
                    4;
            ...
            case "toefl": {
                const total = input.listening + input.reading + input.speaking + input.writing;
                const cefr = EnglishProficiency.getCefr(input.test, total);
                return {
                    total,
                    cefr,
...
exports.EnglishProficiency = EnglishProficiency;
