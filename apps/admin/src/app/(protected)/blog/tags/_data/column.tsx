...
import { ICategory, ITag } from "@workspace/shared";
...
import { deleteTag } from "../_actions";
...
export const columns: ColumnDef<ITag>[] = [
  {
    ...
    cell: (info) => {
      ...
      return (
        <DataTableRowActions>
          <HasPermission resourceName="tags" action="delete" args={[tag]}>
            <DropdownMenuItem
