...
export type ResourceType = "departments" | "teams" | "admins" | "faqs" | "inquiries" | "schools" | "accommodations" | "intakes" | "programs" | "blogs" | "categories" | "tags";
export type PermissionType = {
    admins: {
        dataType: IAdmin;
        createDataType: CreateAdminSchema;
        updateDataType: UpdateAdminSchema;
        action: "list" | "create" | "read" | "update" | "delete" | "deactivate" | "activate";
    };
    departments: {
